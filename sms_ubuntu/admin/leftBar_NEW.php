  ...
  <div id="left">
    ...
    <div class="media user-media hidden-phone">
      ...
      <div class="media-body hidden-tablet">
        <h5 class="media-heading" href="Profile.php"><?php echo $_SESSION['SESS_ADMIN_NAME'] ; ?></h5>
  ...
  <ul id="menu" class="unstyled accordion collapse in">
    ...
    <li ><a href="../LLS/Timetable01.php?lls=timetable1"><i class="icon-time icon-large"></i> Timetable</a></li>								
  </ul>
  <!-- /#menu -->
</div>
<!-- /#left -->