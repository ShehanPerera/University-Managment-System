			  ...
			  <div class="row-fluid">
				...
				<div class="span12">
				  <div class="box">
					<header>                                      
					  <h5>
						<a href="../../UMS/r_admin/CreateAccounts.php" role="button" class="btn" data-toggle="modal">Add New Head</a>  
					  </h5>
						<div class="toolbar">
							...
							<?php
								...
								$str = $row['fname'] . "|" 
									...
									echo '<td><div align="center">
										<a href="../../UMS/user/editpage.php" rel="facebox" data-toggle="modal" onclick=AssignValue("' . $str . '")>Edit</a> 
										</div></td>';
									echo '</tr>';
									}
							?>		 
