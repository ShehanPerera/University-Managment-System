            ...
            <div class="span12">
              <h4>
                ...
                <font color="#FFFFFF"> | </font>
       			<a class="pagepath" href="subject_compination.php">
                Subject Compination</a>
               </h4>
            </div>
          </div>
          <!-- /.row-fluid -->
                  ...
                  <div class="row-fluid">
                    <div class="span12">
                      <div class="box">
                        <header>
                          <h5>
                            <a href="#editSubject" role="button" class="btn" data-toggle="modal">Add New subject combination</a>							
							<a rel="facebox" href="combination_view.php" id="addq"><button class="btn edit">View submitted list</button></a>	
