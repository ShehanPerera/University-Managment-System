  ...
  <head>
                  ...
                  <div class="row-fluid">
                    <div class="span12">
                      <div class="box">
                        <header>
                          <h5>
                            <a href="#editYear" role="button" class="btn" data-toggle="modal">Add New Year</a>                        
                          </h5>
                        </header>
                          ...
                          <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                            ...
                            <?php
                              ...
                              while($row = mysql_fetch_array($result)){
								...
								<a href="#editYear" rel="facebox" data-toggle="modal" onclick=AssignValue("' . $str . '")>Edit</a> | 
								<a href="#" id="'.$row['id'].'" class="delbutton" title="Click To Delete">delete</a> | 
								<a id="'.$row['id'].'"  title="Subjects" onclick=Subjects("' . $row['yearcd'] . '")>Subjects</a></div></td>';
                                echo '</tr>';
                              }
                              ?> 
                            </tbody>
    ...
    <script type="text/javascript" src="../assets/js/main.js"></script>
      ...
      function Subjects(rsYearCd){
        frmYear.method = "post";
        frmYear.action = "acyearsubjectedit.php?hsYearCd="+rsYearCd;
        frmYear.submit();
      }
