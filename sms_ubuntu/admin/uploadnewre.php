            ...
            <div class="span12">
              <h4>
                ...
                Dashboard </a> <font color="#FFFFFF"> | </font>
                      ...
                      Results</a><font color="#FFFFFF"> | </font>
...
<body>
<form id="fileuploader"enctype="multipart/form-data" action="uploadre.php" method="post" name="upload-form" id="upload-form">
	...
	<!--div  id="dvFile0"><input  type="file" name="item_file[]" onChange="checkExtension(this.value)"></input></div><div  id="dvFile1"></div><br>
        <button class="btn edit" href="javascript:_add_more(0);">(+) Add file</button>
	<button class="btn edit" name="upload" value="Upload">Upload</button-->
</form>
