...
<title>Lecturehall Schedule</title>
    ...
    <div id="inner">
      <div class="left float-l">
        ...
        <table width="268" border="0">
          ...
          <tr>
            <td height="35" colspan="2">Lecturehall no</td>
            <td colspan="2">
              <label for="textfield"></label>
              <input type="text" size="5" required="required" placeholder="hall no" maxlength="5" value="<?php echo $lls; ?>" name="hall" id="textfield" />
           </td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="43" colspan="2">Water facility</td>
            <td colspan="2"><select name="water" id="select">
          ...
          <tr>
            <td width="71" height="56">
              <div align="left">
			  <?php if($state=="") { ?>
                <input type="submit" name="search" id="button" value="Search" />
              </div>
               </td>
            <td width="62"><input type="submit" name="insert" id="button2" value="Insert" /></td>
            <?php } if(($state=="up") or ($state=="se") ){ ?>
			<td width="66" height="56"><input type="submit" name="update" id="button3" value="Update" /></td>
            <?php } if(($state=="de") or ($state=="se") ) { ?>
			<td width="51"><input type="submit" name="delete" id="button4" value="Delete" /></td>
          <?php } ?>
		  </tr>
        </table>
		</form>
        ...
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p><img name="" src="images/slideshow/lec/lec2.JPG" width="399" height="350" alt="" /></p>
        <p>&nbsp;</p>
