...
<title> View SessionDetails</title>
    ...
    <div id="inner">
      ...
      <div id="imagetable">
		...
		while($row=mysql_fetch_array($result))
		{
			...
			echo "<td><div contenteditable>" . $row['Session_Name'] . "</td>";
			echo "<td><div contenteditable>" . $row['Level'] . "</td>";
			echo "<td><div contenteditable>" . $row['Head_Count'] . "</td>";
			echo "<td><a href='SessionDetails.php?lls=".$row['Session_Code'].',up'."'>Edit</a>" . "</td>";
			echo "<td><a href='SessionDetails.php?lls=".$row['Session_Code'].',de'."'>Delete</a>" . "</td>";
			echo "</tr>"; 
		}
		echo "</table>";
        ...
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p><img name="" src="images/slideshow/lec/lec2.JPG" width="423" height="293" alt="" /></p>
		<p>&nbsp;</p>
