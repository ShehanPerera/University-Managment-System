  ...
  <div id="content">
    <div id="inner">
      ...
      <div id="imagetable">
		...
		$result=mysql_query("SELECT * FROM venue WHERE 	Venue_Type='Laboratory'");
		//<td width="80"><div align="center">Laboratory no</div></td>
		echo "<table  cellspacing='2' cellpadding='20' border='2'>
		<tr>
		<th>Laboratory no</th>
		<th>Head count</th>
		...
		while($row=mysql_fetch_array($result))
		{
			...
			echo "<td><a href='LaboratoryMore.php?lls=".$row['Venue_No'].',up'."'>Edit</a>" . "</td>";
			echo "<td><a href='LaboratoryMore.php?lls=".$row['Venue_No'].',de'."'>Delete</a>" . "</td>";
			echo "</tr>"; 
		}
		echo "</table>";
		?>
        ...
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p><img name="" src="images/slideshow/lab/lab1.jpg" width="416" height="320" alt="" /></p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
