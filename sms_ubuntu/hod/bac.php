...
<html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <title>Basic Computing Level 1G</title>
    ...
    <div id="wrap">
      ...
      <div class="main-bar">
        ...
        <h4>
                ...
                Past Paper </a>
                <a class="pagepath" href=" supplementarysub.php">
                <font color="#FFFFFF"> | </font>
                Supplementary Subjects </a> 
                <a class="pagepath" href="bac.php">
                <font color="#FFFFFF"> | </font>
                Basic Computing</a>
               </h4>
            </div>
...
<tr>
	...
	<?php
		$query1 = "SELECT * FROM bac LIMIT 10";
