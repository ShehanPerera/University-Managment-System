...
function output_file($file, $fname, $type='')
{
 /*
 This function takes a path to a file to output ($file),  the filename that the browser will see ($name) and  the MIME type of the file ($type, optional).
 */
