  ...
  <body>
    ...
    <div id="wrap">
      ...
      <div id="content">
	    ...
	    <hr>
	     <div class="tac">
			<a class="quick-btn" href="mmt1g.php">
			<img   src="../assets/img/1g.png" >
			<span>1G</span>
		   </a>
		   <a class="quick-btn" href="mmt2g.php">
			<img   src="../assets/img/2g.png" > 
			<span>2G</span>
		   </a>
		   <a class="quick-btn" href="mmt3g.php">
			<img   src="../assets/img/3g.png" > 
			<span>3G</span>
		   </a>
		   	<a class="quick-btn" href="mmt4m.php">
