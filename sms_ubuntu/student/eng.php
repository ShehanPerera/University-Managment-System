  ...
  <body>
    ...
    <div id="wrap">
          ...
          <div class="row-fluid">
            <div class="span12">
              <h4>
                ...
                Past Paper </a>
                <a class="pagepath" href="auxiliarysub.php">
                <font color="#FFFFFF"> | </font>
                Auxiliary Subject </a> 
                <a class="pagepath" href="eng.php">
                <font color="#FFFFFF"> | </font>
                English</a>
               </h4>
            </div>
      ...
      <div id="content">
	    ...
	    <hr>
	     <div class="tac">
			<a class="quick-btn" href="eng1g.php">
			<img   src="../assets/img/1g.png" >
			<span>1G</span>
		   </a>
		   <a class="quick-btn" href="eng2g.php">
			<img   src="../assets/img/2g.png" > 
			<span>2G</span>
		   </a>
		   <a class="quick-btn" href="eng3g.php">
