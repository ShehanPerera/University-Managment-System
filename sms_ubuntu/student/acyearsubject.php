  ...
  <body>
    ...
    <div class="main-bar">
      <div class="container-fluid">
        <div class="row-fluid">
          <div class="span12">
            <h3><i class="icon-check-empty"></i>Current Subject</h3>
          </div>
        </div>
        <!-- /.row-fluid -->
      </div>
                      ...
                      <table class="table table-bordered sortableTable responsive">
                        ...
                        <tbody>
                          ...
                          $sql = "SELECT a.*, COALESCE(b.subjectcd,'') subjectcd"
                            ...
                            if($row['subjectcd'] == ''){
                              echo '<td><div align="center"><a rel="facebox" href="#"><input type="checkbox" name=selcod[] value= ' . $row['code'] . ' ></a></div></td>';
                            }
                            else{
                              echo '<td><div align="center"><a rel="facebox" href="#"><input type="checkbox" name=selcod[] value='.$row['code'].' checked ></a></div></td>';
                            }
                            echo '</tr>';
                          }
                          ?> 
