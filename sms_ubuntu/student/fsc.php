  ...
  <body>
    ...
    <div id="wrap">
      ...
      <div id="content">
	    ...
	    <hr>
	     <div class="tac">
			<a class="quick-btn" href="fsc1g.php">
			<img   src="../assets/img/1g.png" >
			<span>1G</span>
		   </a>
		   <a class="quick-btn" href="fsc2g.php">
			<img   src="../assets/img/2g.png" > 
			<span>2G</span>
		   </a>
		   <a class="quick-btn" href="fsc3g.php">
			<img   src="../assets/img/3g.png" > 
			<span>3G</span>
		   </a>
		   	<a class="quick-btn" href="fsc4m.php">
