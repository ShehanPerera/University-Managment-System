...
if(!empty($_POST['image']))
	...
	include('connection.php');
	$query = mysql_query("INSERT INTO user(user_id,title,first_name,nic,email,contact,address,last_name,password,username,image,position,accept,reg_no,department,special,combination,level) VALUES('$id','$title','$fname','$nic','$emails','$phone','$address','$lname','$pass','$user1','$image','$position','false','$reg_no','$department','$special','$combination','$level')") or die (mysql_error());
