        ...
        <div id="content" class="col-lg-10 col-sm-10">
			...
			<div class="row">
				<div class="header" data-original-title="">
					<h2><i class=" glyphicon glyphicon-user"> View Heads</i></h2>
				</div>
			</div>
...
$query ="SELECT * FROM user WHERE (position ='head' ) ORDER BY user_id ASC";
  ...
  while($query_row =mysql_fetch_array($result1))
   {
			...
			echo '<td>';		  
			echo '<button type="submit"  width="1" title="Update" class=" center btn btn-info glyphicon glyphicon-repeat" value ="Save" name ="save'.$i.'"></button>';
