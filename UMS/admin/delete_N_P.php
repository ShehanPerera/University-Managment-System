			...
			//gayan
	            ...
	            $result =mysql_query($query);
	             if($result)
	             {
					...
					echo "<script type='text/javascript'>alert('Delete successfully');window.location =\"New_Profiles.php\"</script>";
	             ...
	             else
				{
					...
					echo "<script type='text/javascript'>alert('Delete is faild');window.location =\"New_Profiles.php\"</script>";
