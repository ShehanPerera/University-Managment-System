...
<div class="table-responsive">
  <table class="table">
   	<caption><h4 style="color:red" align="center">Sent message to other HOD</h4></caption>
	   	<tr class="info">
		<th colspan="6"><a href="index.php?option=add_sent_message" title="send message to other HOD">Send message </a></th>
		</tr>
		<tr class="success">
		<th>Sr. No</th>
		<th>Instructor</th>
