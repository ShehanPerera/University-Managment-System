      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
		  ...
		  <ul class="nav navbar-nav navbar-right">
					<li>
					<a  href="../UMS/index_R_S.php" style="color:#fff">
					<span class=""></span>UMS</a>
					</li>
					<li>
...
<?php
			...
			?>
					<ul class="nav navbar-nav navbar-right">
						<li>
			<a href="../UMS/index_multi.php"  data-target="#log"style="color:#fff" >
			<span ></span>UMS</a>
		</li>
					
					<li>
			<a href="../UMS/login.php"  data-target="#log"style="color:#fff" >
			<span class="glyphicon glyphicon-lock"></span>Sign in</a>
		</li>

	<li>
			<a  href="../UMS/CreateNew.php"  style="color:#fff">
