...
<button type="submit" onclick="location.href = 'drug_add.php'" > ADD NEW DRUGS
			</button>
<?php
...
<center><form action="filtertodrugs.php" method="post"></center>
...
<td> <?php echo $row['Marketing_status']; ?> </td>
<td> <?php echo $row['Company']; ?> </td>
<td> <?php echo $row['Expires_date']; if($row['Expires_date']< date('Y-m-d H:i:s')){ ?> <img src="not/error.png" alt="" height="15" width="15">   <?php } ?> </td>
<td align="center"><a id="<?php echo $row['no']; ?>"  href="drug_edit.php?id=<?php echo $row['no']; ?>" title="Edit">Edit</a></td>
<td align="center"><a id="<?php echo $row['no']; ?>"  href="drug_delete.php?id=<?php echo $row['no']; ?>" title="Delete">Delete</a></td>
