...
if(isset($_POST['search']))
{
	...
	$quary="select * from prescription where stregno LIKE '%".$regnotosearch."%' ";
...
<center><input type="text" name="regnotosearch" placeholder=" Enter Registation Number"><br></center>
<br>
