...
<center><form action="indextestupdate.php" method="post"></center>
...
{
	echo "<tr> <form action=Edit_Report.php method=post>";
	
	echo "<td>Test_type: <input type=text name=test_type value='".$row['test_type']."'></td>";
	echo "<td>Stregno: <input type=text name=stregno value='".$row['stregno']."'></td>";
	echo "<td>TreatmentId: <input type=text name=treatmentid value='".$row['treatmentid']."'></td>";
	echo "<td> Test:<input type=text name=test_result value='".$row['test_result']."'></td>";
	echo "<td> Date:<input type=text name=date value='".$row['date']."'></td>";
