	...
	//-->
		...
		<h1> Add New Medical Staff Details</h1>
                            <div class="tab-pane active" id="1">
                             <form action="medoff.php" method="post" name="frm_signup" id="third" enctype="multipart/form-data" onsubmit="return validate(this);" >
	...
	<div id="meddetails_div">
		<table width="550" cellspacing="0" cellpadding="3">
			...
			<tr>
				 ...
				 <td>:</td>
				 <td><h7><input type="password" name="password" onChange="return(checkLengthOfPasword(form1));" size="40" class="InputText" style="width: 160px;"></td>
			 </tr>
			 <tr>
				 <td></td>
				 <td></td>
...
<?php 
  if(isset($_POST['submitMain']))
  {
	...
	$query = "INSERT INTO  user (usertype,name,phoneno,email,password,username)
