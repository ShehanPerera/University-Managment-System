...
<ul>
	...
	<li><a class="active" href="viewtestrequire.php">View Test Requirement</a></li>
		...
		<h1><center>Lab Test Page</Center></h1>
<?php
include("conn.php"); ?>
<form  action="testnew.php" method="post"><big><big><br>
<center><p><table><tr><td>
  Test Type </td><td>
  ...
  <tr><td>
  <p>Treatment ID</td><td>  
    <input type="text" name="treatmentid" id="textfield5" class="validate[required]"/>
  </p></td></tr>
    
  <tr><td>
  <p>Test Results  </td>
    <label for="textarea"></label><td>
    <textarea name="test_result" id="textarea" cols="45" rows="10"></textarea>
  </p></td></tr></table>
  <tr><td>
  <p>Date&nbsp;&nbsp;&nbsp;&nbsp;</td><td> &nbsp;&nbsp; &nbsp;&nbsp;
