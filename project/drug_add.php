...
if($_POST)
	{
		...
		$sql = "INSERT INTO tabletavai(tabletName,storkAvail,Dosage_form,Strength,Marketing_status,Company,Expires_date) VALUES('$drug','$sto','$dos','$str','$mar','$com','$exp')";	
...
function handleCheck(y)
	...
	//-->
		...
		<br><br><br><br><br>
<form method='post' id='emp-UpdateForm' action='drug_add.php' >
        ...
        <tr>
            ...
            <td><input type='text' name='drug'  class='form-control'  required /></td>
				...
				<tr>
            <td>storkAvail</td>
            <td><input type='text' name='sto'  class='form-control' required /></td>
        </tr>

				<tr>
            <td>Dosage Form/Route</td>
            <td><input type='text' name='dos'  class='form-control' required /></td>
					</tr>
						<tr>
            <td>Strength</td>
            <td><input type='text' name='str' class='form-control'required /></td>
</tr>
<tr>
            <td>Marketing Status</td>
            <td><input type='text' name='mar' class='form-control' required /></td>
        </tr>
		<tr>
            <td>Company</td>
            <td><input type='text' name='com' class='form-control' required></td>
        </tr>
		<tr>
            <td>Expiry Date</td>
