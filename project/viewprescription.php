...
if(isset($_POST['search']))
{
	...
	$quary="select * from prescription where stregno LIKE '%".$regnotosearch."%' and date LIKE '%".$datetosearch."%'";
	$searchresult=filtertable($quary);
}
else
{
	$quary="select * from prescription";
	$searchresult=filtertable($quary);
}
...
<center><form action="viewprescription.php" method="post"></center>
<center><input type="text" name="regnotosearch" placeholder="Enter Registation No" ><br><br><input type="text" name="datetosearch" placeholder="Enter Date"><br></center>
<br>
...
<td> <?php echo $row['drugname_drugvalue']; ?> </td>
<td><input type="checkbox" <?php echo $a;?> onclick="handleCheck('<?php echo $row["stregno"]; ?>')"name="check_list[]" /></td>
</tr>
			<?php } ?>
</table>
</center>
