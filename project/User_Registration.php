...
<!--
	...
	//-->
		...
		<h1> Add New Medical Staff Details</h1>
                            <div class="tab-pane active" id="1">
                             <form action="insert_new_user.php" method="post" name="frm_signup" id="third" enctype="multipart/form-data" onsubmit="return validate(this);" >
	...
	<div id="meddetails_div">
		<table width="550" cellspacing="0" cellpadding="3">
			<h3>New Medical Officer Registration</h3>
...
<fieldset>
	  ...
	  <table class="thick" width="30%">
		<tbody>
		
		  <tr>
			<td style="text-align: left;">Name<br>
			</td>
			<td><input name="uname" type="text"><br>
			</td>
		  </tr>
		  
		  <tr>
			<td style="text-align: left;">E-mail Address<br>
			</td>
		  ...
		  <tr>
		  <td  style="text-align: left;">Occupation
		  </td>
		  <td><input name ="job" type="text"><br>
		  </td>
		  </tr>
		  
		  <tr>
		  <td  style="text-align: left;">Employee Number
		  </td>
		  <td><input name ="regno" type="text"><br>
		  </td>
		  </tr>
		  
		  <tr>
		  <td  style="text-align: left;">User Type<br>
		  </td>
		  <td><input type="radio" name="user_type" value="admin" />Admin <br>
			<input type="radio" name="user_type" value="doctor" />Doctor<br>
			<input type="radio" name="user_type" value="pharmacist" />Pharmacist<br>
			<input type="radio" name="user_type" value="receptionist" />Receptionist<br>
			<input type="radio" name="user_type" value="technician" />Technician<br>
		  </td>
		  </tr>
		  
		  <tr>
		  <td  style="text-align: left;">User Name<br>
		  </td>
		  ...
		  <tr>
				 ...
				 <td><h7><input type="password" name="pass" onChange="return(checkLengthOfPasword(form))" size="40" class="InputText" style="width: 160px;"></td>
			 </tr>
			 <tr>
			 ...
			 <tr>
				 ...
				 <td><h7><input type="password" name="repass"  size="40" class="InputText" style="width: 160px;"></td>
			 </tr> 
		 
		 <tr><td>
		 <input type="submit" name="submit" value="REGISTER" onClick="Confirm(this.form)"></td>
		 <td>
