...
<div class="navbar navbar-fixed-top navbar-inverse">
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand" href="#">Health Center</a>
...
<!--
	...
	//-->
		...
		<h1> Add New Student Details</h1>
                            <div class="tab-pane active" id="1">
                                <form action="student.php" method="post" name="frm_signup" id="third" enctype="multipart/form-data" onsubmit="return validate(this);" >
	...
	<div id="userdetails_div">
		<table width="550" cellspacing="0" cellpadding="3">
			...
			<tr>
				 ...
				 <td>:</td>
				 <td><h7><input type="password" name="pass" onChange="return(checkLengthOfPasword(form1))" size="40" class="InputText" style="width: 160px;"></td>
			 </tr>
			 <tr>
				 <td></td>
				 <td></td>
	...
	<div id="pasthistory_div" style="display: none;">
		...
		<tr><td height="10px"></td></tr>
				...
				<td>:</td>
                 <td width="200" align="left"><input type="checkbox" name="illness" id="poll" value="poll">Pollomyelitis </br>
...
//		$fstate = $_REQUEST['rd_fstate'];
	...
	$query1 = "INSERT INTO `hr`.`student_details` (`stregno`, `faculty`, `date`, `fullname`, `raddress`, `paddress`, `dob`, `lastsch`, `password`,`usertype`,`pname`, `address`, `tpno`,  `foccup`, `fage`, `fill`, `fstate`, `moccup`, `mage`, `mill`, `mstate`, `boccup`, `bage`, `bill`, `bstate`, `soccup`, `sage`, `sill`, `sstate`) 
	...
	$query2= "INSERT INTO `hr`.`registration` (`regno`)VALUES ('$stregno')";
	$result2=mysql_query($query2);
	
	$query3="INSERT INTO  `hr`.`user` (`usertype` ,`name` ,`phoneno` ,`password` ,`username`)
