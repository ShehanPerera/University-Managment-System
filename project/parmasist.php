...
$quary="select * from tabletavai WHERE Expires_date <= CURDATE()";
...
<?php if(!$res ==0 ) { ?>
  ...
  <div class="center" ><span id="head-image"><img src="not/error.png" alt="" height="25" width="25">
  <?php echo $row['tabletName']."(".$row['Strength'].",".$row['Company'].")" ?> expired</span></div>
  <?php } ?>
...
<div class="navbar navbar-fixed-top navbar-inverse">
    <div class="navbar-inner">
        <div class="container-fluid">
			...
			<a class="active" href="parmasist.php">Home</a>
...
<div class="container-fluid">
	...
	<li><a class="active" href="filtertodrugs.php">Edit Details</a></li>
	<li><a class="active" href="viewprescription.php">View Prescription</a></li>
				...
				<li class="span11">
                        <div class="thumbnail">
                            ...
                            <div class="caption" >
                                <h5 align="center">Receptionist</h5>
