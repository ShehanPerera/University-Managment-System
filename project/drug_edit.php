...
if($_POST)
	{
		...
		$com = $_POST['com'];
		$exp = $_POST['exp'];
		$sql="update tabletavai set tabletName='$drug',storkAvail='$sto',Dosage_form ='$dos',Strength='$str',Marketing_status='$mar',Company='$com',Expires_date='$exp' where no=$id";
    ...
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <div class="nav-collapse">
                <ul class="nav">
                    <li class="active"><a href="parmasist.php">Home</a></li>
...
function handleCheck(y)
	...
	//-->
        ...
        <!--/span-->
		<button><a href="parmasist.php">Back</a></button>
...
{
	$id = $_GET['id'];	
	$stmt=mysqli_query($conn,"SELECT * FROM  tabletavai WHERE no='$id'");
...
<form method='post' id='emp-UpdateForm' action='drug_edit.php' >
<input type="hidden" name='id' value='<?php echo $row['no']; ?>' class='form-control' />
					<table>	
        <tr>
            <td>Drug Name</td>
            <td><input type='text' name='drug' value='<?php echo $row['tabletName']; ?>' class='form-control'  required /></td>
        </tr>

				<tr>
            <td>storkAvail</td>
            <td><input type='text' name='sto' value='<?php echo $row['storkAvail']; ?>' class='form-control' required /></td>
        </tr>

				<tr>
            <td>Dosage Form/Route</td>
            <td><input type='text' name='dos' value='<?php echo $row['Dosage_form']; ?>' class='form-control' required /></td>
					</tr>
						<tr>
            <td>Strength</td>
            <td><input type='text' name='str' value='<?php echo $row['Strength']; ?>' class='form-control'required /></td>
</tr>
<tr>
            <td>Marketing Status</td>
            <td><input type='text' name='mar' value='<?php echo $row['Marketing_status']; ?>' class='form-control' required /></td>
        </tr>
		<tr>
            <td>Company</td>
            <td><input type='text' name='com' value='<?php echo $row['Company']; ?>' class='form-control' required></td>
        </tr>
		<tr>
            <td>Expiry Date</td>
            <td><input type='date' name='exp' value='<?php echo $row['Expires_date']; ?>' class='form-control' required /></td>
        </tr>
